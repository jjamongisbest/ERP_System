...
VALUES 
  ...
  --------- 이하 새로 추가할 데이터 ---------
  (400111, 1001011, '2023-04-07', 55000, 'Y'),
  (400112, 1001012, '2023-04-06', 20000, 'N'),
  (400113, 1001013, '2023-04-05', 15000, 'D'),
  (400114, 1001014, '2023-04-04', 35000, 'Y'),
  (400115, 1001015, '2023-04-03', 45000, 'N'),
  (400116, 1001016, '2023-04-02', 50000, 'D'),
  (400117, 1001017, '2023-04-01', 10000, 'Y'),
  (400118, 1001018, '2023-03-31', 30000, 'Y'),
  (400119, 1001019, '2023-03-30', 25000, 'N'),
  (400120, 1001020, '2023-03-29', 40000, 'N'),
  (400121, 1001021, '2023-03-28', 50000, 'Y'),
  (400122, 1001022, '2023-03-27', 15000, 'N'),
  (400123, 1001023, '2023-03-26', 25000, 'D'),
  (400124, 1001024, '2023-03-25', 30000, 'Y'),
  (400125, 1001025, '2023-03-24', 20000, 'N'),
  (400126, 1001026, '2023-03-23', 40000, 'D'),
  (400127, 1001027, '2023-03-22', 45000, 'Y'),
  (400128, 1001028, '2023-02-21', 5000, 'Y'),
  (400129, 1001029, '2023-02-20', 10000, 'N'),
  (400130, 1001030, '2023-02-19', 35000, 'N'),
  (400131, 1001031, '2023-02-18', 30000, 'Y'),
  (400132, 1001032, '2023-02-17', 20000, 'N'),
  (400133, 1001033, '2023-01-16', 15000, 'D'),
  (400134, 1001034, '2023-01-15', 50000, 'Y'),
  (400135, 1001035, '2023-01-14', 45000, 'N'),
  (400136, 1001036, '2023-01-13', 35000, 'D'),
  (400137, 1001037, '2023-01-12', 10000, 'Y'),
  (400138, 1001038, '2023-01-11', 40000, 'Y');